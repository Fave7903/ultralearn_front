...
class Signup extends Component {
  ...
  render() {
    ...
    return (
      ...
      <p className="float-start mt-n3 "><img src={ultralearn} className="image-fluid me-n4" alt="Student"/>UltraLEARN</p>
                    ...
                    <figure>
                <img src={ultralearn} className="img-fluid  mx-a" alt="Student"/>
                <figcaption className="  text-center caption"> Exploring Growth Conversations</figcaption>
                </figure>
  ...
  <span className="sr-only">Loading...</span>
        ...
        <form>
          ...
          <div className="">
<p>
<input className="form-check-input" type="checkbox" value="" id="defaultCheck1"/>Creating an account means you accept our <a href=''className="fw-bold">Terms and Conditions</a>
</p>
                </div>
